                    ...
                    <div class="shopping-cart__totals-wrapper">
                        <div class="sticky-content">
                            ...
                            <div class="mobile_fixed-btn_wrapper">
                                @guest
                                    <p>You need to <a style="color: aqua;" href="{{ route('login') }}"> LOG IN</a> to purchase items. </br>
                                        If you don't have an account, <a style="color: lightcoral;" href="{{ route('register') }}">REGISTER </a> here.
                                    </p>
                                @else
